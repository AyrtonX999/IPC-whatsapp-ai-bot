...
SYSTEM_INSTRUCTION_TEXT = (
    ...
    "7. Ofrece al cliente en el saludo del primer mensaje utilizar la herramienta de Interpolacion para calibraciones mediante este link https://ipcassociates-la.com/interpolacion.html"
)
